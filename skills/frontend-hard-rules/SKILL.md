---
name: frontend-hard-rules
description: Hard rules for branded frontend design and implementation. Use when building or reviewing landing pages, marketing sites, promotional surfaces, branded React pages, or other frontend work where composition, brand hierarchy, full-bleed hero treatment, restrained sectioning, real visual anchors, intentional motion, and non-generic art direction matter. Also use when React frontend work should prefer modern patterns like useEffectEvent, startTransition, and useDeferredValue when appropriate.
---

# Frontend Hard Rules

Apply these rules verbatim. Relax them only when the stated exception applies.
